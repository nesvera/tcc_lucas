...
void sistema_step(void)
{
  ...
  /* '<S12>:1:9' */
  /* '<S12>:1:12' */
  w1d_sq = (-sistema_U.Z_XPlane - -2784.36F) - sistema_U.referencias[0];
  u_phi = (sistema_U.X_XPlane - -35162.5313F) - sistema_U.referencias[1];
  ...
  /* '<S11>:1:30' */
  w1d_sq = (-sistema_U.Y_XPlane - -180.6F) - sistema_U.referencias[2];
